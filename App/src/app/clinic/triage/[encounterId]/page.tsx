  ...
  if (!encounter) {
    return (
      <div className="text-center py-20">
        ...
        <Link href="/clinic/triage" className="text-[#266AFB] font-bold underline text-sm mt-2 inline-block">
    ...
    <div className="max-w-3xl mx-auto space-y-6 pb-24 animate-in fade-in duration-500">
        ...
        <div className="p-6 flex items-center gap-5">
          {client.profileImage ? (
            ...
            <div className="w-20 h-20 rounded-2xl bg-[#EBF1FF] flex items-center justify-center shrink-0">
              <span className="text-[#266AFB] font-black text-xl">
      ...
      <section className="space-y-4">
        <h3 className="text-xs font-black text-gray-400 uppercase tracking-[0.2em] flex items-center gap-2">
          <Activity size={14} className="text-[#266AFB]" />
          Vital Signs
        </h3>
